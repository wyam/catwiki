...
describe('catsService', () => {
    ...
    it('should call api to get results of all breeds cat', async () => {
        // given
        const spyGetBreeds = jest.spyOn(thecatapi, 'getBreeds');
        spyGetBreeds.mockResolvedValueOnce([
            {
                "weight":{
                    "imperial":"7  -  10",
                    "metric":"3 - 5"
        ...
        // when
        const catsBreed = await catsService.getBreeds();
        // then
        expect(catsBreed).toEqual([
